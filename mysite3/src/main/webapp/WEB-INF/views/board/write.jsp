			...
			<div id="board">
				<form class="board-form" method="post"
					...
					<input type="hidden" name="page" value="${param.page}"> <input
						type="hidden" name="g_no" value="${vo.g_no }"> <input
						type="hidden" name="o_no" value="${vo.o_no }"> <input
					...
					<div class="bottom">
						<a
							href="${pageContext.servletContext.contextPath }/board/list?page=${page }">취소</a>
